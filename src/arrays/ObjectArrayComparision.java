...
public class ObjectArrayComparision {
	
	public static ArrayList<Object> getUIPaymentDetailsforCombinePayments() throws Exception
	{
	...
	public static void main(String[] args) throws Exception {	
		ArrayList<Object> a=getUIPaymentDetailsforCombinePayments();
